...
async function runTheLearningSamples() {
  ...
  console.log(whatIsIt_string('Hello World!!'));

  function whatIsIt_any(arg: any): any {
    return arg;
  }
  console.log(whatIsIt_any(12));
  console.log(whatIsIt_any('Hello World!!'));

  function whatIsIt_typed<T>(arg: T): T {
    return arg;
  }

  let n: number = whatIsIt_typed<number>(15);
  let s: string = whatIsIt_typed<string>('Ciao');
